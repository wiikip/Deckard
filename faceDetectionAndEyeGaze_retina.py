    ...
    if len(faces) != 0:
        ...
        for (ex, ey, ew, eh) in eyes_sorted:
            ...
            _, threshold = cv2.threshold(
                eye_gray_roi, 35, 255, cv2.THRESH_BINARY_INV)
            ...
            if len(contours_sorted) != 0:
                ...
                cv2.rectangle(eye_color_roi, (cx, cy),
                ...
                if compteur_yeux == 0:
                    ...
                    oeil1_me_regarde = (24*pas_x < abscisse_du_centre < ew-24 *
                                        pas_x) and (24*pas_y < ordonnee_du_centre < eh-24*pas_y)

                else:
                    oeil2_me_regarde = (24*pas_x < abscisse_du_centre < ew-24 *
                                        pas_x) and (24*pas_y < ordonnee_du_centre < eh-24*pas_y)
